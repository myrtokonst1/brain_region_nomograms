...
from constants.table_columns import intercranial_ratio_cn, latest_age_cn, scan_date_cn, standard_brain_icv, \
    ethnicity_cn, \
    white_british_code, cranial_vol_cn, l_amygdala_vol_cn, r_amygdala_vol_cn, min_age, max_age
...
def generate_and_merge_dataframes():
    ...
    bb_df = pd.merge(pd.merge(main_ukb_df, brain_ukb_df, on=participant_id, how='outer'),
                     ukb_preprocessed_df[[participant_id, latest_age_cn]], on=participant_id, how='outer')
